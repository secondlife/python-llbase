# -*- coding: utf-8 -*-
#
# llbase documentation build configuration file, created by
# sphinx-quickstart on Thu Dec 10 11:10:32 2009.
#
...
latex_documents = [
  ('index', 'llbase.tex', 'llbase Documentation',
   'Phoenix', 'manual'),
]
